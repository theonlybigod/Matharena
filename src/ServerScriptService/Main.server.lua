...
local PlayerAuraEffect = require(script.Parent.PlayerAuraEffect)
...
-- Cosmetic per-map player aura (embers on Lava, bubbles on UnderTheSea).
-- Purely visual and map-gated, so it can sit anywhere in this sequence;
-- placed here to keep it beside the other presentation systems.
PlayerAuraEffect.Init()
