...
--[[
	...
	the wall screen inside the Tutorial building can present the SAME text
	without a second copy of it. See that module's header for why.
]]
local TOPICS = require(ReplicatedStorage.Modules.TutorialTopicsConfig).TOPICS
