...
GameplayConfig.QUEUE_TIERS = {
	{ id = 1, name = "Easy Mode", description = "Simple single-digit addition.", startingRound = 1, maxRound = 2 },
	{ id = 2, name = "Medium Mode", description = "Mixed addition, subtraction, multiplication, and division.", startingRound = 3, maxRound = 4 },
	{ id = 3, name = "Hard Mode", description = "Fractions.", startingRound = 5, maxRound = 6 },
	{ id = 4, name = "Expert Mode", description = "Square roots.", startingRound = 7, maxRound = 7 },
	{ id = 5, name = "Master Mode", description = "Algebra, decimals, exponents, and geometry.", startingRound = 8, maxRound = nil },
} :: { QueueTier }
